...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_LDK_NODE_FN_METHOD_BOLT11PAYMENT_RECEIVE_FOR_HASH_WITH_MIN_CLTV_EXPIRY_DELTA
#define UNIFFI_FFIDEF_UNIFFI_LDK_NODE_FN_METHOD_BOLT11PAYMENT_RECEIVE_FOR_HASH_WITH_MIN_CLTV_EXPIRY_DELTA
void* uniffi_ldk_node_fn_method_bolt11payment_receive_for_hash_with_min_cltv_expiry_delta(void* ptr, uint64_t amount_msat, RustBuffer description, uint32_t expiry_secs, RustBuffer payment_hash, uint16_t min_cltv_expiry_delta, RustCallStatus *out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_LDK_NODE_FN_METHOD_BOLT11PAYMENT_RECEIVE_VARIABLE_AMOUNT_FOR_HASH_WITH_MIN_CLTV_EXPIRY_DELTA
#define UNIFFI_FFIDEF_UNIFFI_LDK_NODE_FN_METHOD_BOLT11PAYMENT_RECEIVE_VARIABLE_AMOUNT_FOR_HASH_WITH_MIN_CLTV_EXPIRY_DELTA
void* uniffi_ldk_node_fn_method_bolt11payment_receive_variable_amount_for_hash_with_min_cltv_expiry_delta(void* ptr, RustBuffer description, uint32_t expiry_secs, RustBuffer payment_hash, uint16_t min_cltv_expiry_delta, RustCallStatus *out_status
);
#endif
...
RustBuffer uniffi_ldk_node_fn_method_unifiedqrpayment_send(void* ptr, RustBuffer uri_str, RustBuffer route_parameters, RustCallStatus *out_status
);
#endif
